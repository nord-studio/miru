...
By default, the monitoring service will automatically create incidents for you when a monitor goes down and resolve them when the monitor comes back online. It will also alert any subscribers and workspace members. You can disable this feature in Miru's config file.
