...
services:
    ...
    monitor:
        ...
        image: ghcr.io/nord-studio/miru/monitor:0.3.5-amd64
        ports:
            - "8080:8080"
        environment:
    ...
    web:
        container_name: web
        image: ghcr.io/nord-studio/miru/web:0.3.5-amd64
        ports:
            - "3000:3000"
        environment:
            - DATABASE_URL=postgresql://miru:VerySecurePassword123@database:5432/miru
...
services:
    ...
    monitor:
        container_name: monitor
        image: ghcr.io/nord-studio/miru/monitor:0.3.5-arm64
        ports:
            - "8080:8080"
        environment:
            - DATABASE_URL=postgresql://miru:VerySecurePassword123@database:5432/miru
    ...
    web:
        container_name: web
        image: ghcr.io/nord-studio/miru/web:0.3.5-arm64
        ports:
            - "3000:3000"
        environment:
            - DATABASE_URL=postgresql://miru:VerySecurePassword123@database:5432/miru
