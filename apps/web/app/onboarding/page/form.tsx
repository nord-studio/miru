...
import { ArrowRight, CircleCheck, Code, FileQuestion, GripVertical, HelpCircle, Moon, Sun } from "lucide-react";
...
export default function OnboardingStatusPageForm({ monitors, workspace, config }: { monitors: Monitor[], workspace: Workspace, config: MiruConfig }) {
	...
	const [brandColor, setBrandColor] = React.useState<string>("#3b82f6");
	...
	return (
		<>
			<div className="w-full flex flex-row gap-8 items-start justify-center p-8 lg:p-16">
				<div className="flex flex-col gap-2 items-center justify-between w-full">
					<div className="flex flex-col gap-2 items-start w-full">
						...
						<p className="text-neutral-500 dark:text-neutral-400">
							A status page is a place for your customers and users to check your current status. It helps you communicate new incidents and planned maintenances to them. Let&apos;s create one!
						</p>
					</div>
					<div className="flex flex-col items-start justify-center w-full gap-8 pb-8">
						...
						<div className="flex flex-row gap-2 items-center justify-between w-full">
							<Link href="/onboarding/conclusion">
				...
				<div className="hidden md:flex w-full h-full items-start rounded-lg border overflow-hidden">
					{design === "stormtrooper" && (
