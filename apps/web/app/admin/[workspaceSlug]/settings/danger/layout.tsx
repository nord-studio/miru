...
export default async function WorkspaceDangerSettingsPage({ params, children }: { params: Promise<{ workspaceSlug: string }>, children: React.ReactNode }) {
	...
	const canAccess = roleRank >= rankedRoles.owner;
