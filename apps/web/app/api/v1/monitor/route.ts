import { monitorSchema } from "@/app/api/v1/monitor/schema";
...
export async function GET(request: Request) {
	...
	const data = await db.query.monitors.findMany({
		where: () => eq(monitors.workspaceId, key.workspaceId)
	});
