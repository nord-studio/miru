...
const WorkspaceInviteEmail = ({ inviteToken, workspaceName }: WorkspaceInviteEmailProps) => (
	<Html>
		<Head />
			...
			<Container style={container}>
				...
				<div>
					<Section style={buttonContainer}>
						<Button style={button} height={25} width={160} href={`${process.env.NODE_ENV === "development" ? "http://localhost:3000" : `https://${process.env.APP_DOMAIN}`}/join/${inviteToken}`}>
							Accept Invite
						</Button>
					</Section>
					<Text style={paragraph}>
				...
				<Hr style={hr} />
				<Text style={paragraph}>
					This invite will only be valid for the next 2 weeks. If you do
					not want to join this workspace, please ignore this email.
				</Text>
